...
def modelar_banco(df_matrizes, df_touros, df_partos):
    """Carrega as tabelas tratadas em um banco SQLite local."""
...
def gerar_graficos(df_ranking, df_sexo):
    ...
    fig, ax = plt.subplots()
    ax.pie(df_sexo["Total"], labels=df_sexo["Sexo_Cria"], autopct="%1.1f%%", startangle=90)
...
def exportar_relatorio_excel(df_ranking, df_sexo, caminho_ranking, caminho_sexo):
    """Exporta os resultados para um arquivo Excel com abas e gráficos embutidos."""
